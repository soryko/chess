...
class Bishop < Piece
  ...
  def initalize
    @moves = { updiagonal: @updiagonal, downdiagonal: @downdiagonal}
...
class king
  ...
  def initalize
    @moves = { north:(0,1), northE:(-1,1), northW:(1,1), east:(-1,0), west:(1,0), south:(0,-1), southE:(-1,-1), southW:(-1,1)}
  end
end
...
class queen
  ...
  def initalize
    @moves = { updiagonal:@updiagonal, downdiagonal:@downdiagonal, horizontal:@horizontal, vertical:@vertical}
